...
Logolas::nlogomaker(EBF1_disc1,logoheight = 'log', color_profile = color_profile,
           ...
           control = list(quant = 0.5, gap_ylab=3.5,
                          epsilon = 0.1, round_off = 1,
                          posbins = 2, negbins = 3))

seekViewport(paste0("plotlogo", 3))
Logolas::nlogomaker(EBF1_disc1,logoheight = 'ic_log',color_profile = color_profile,
                    frame_width = 1,pop_name = '',
                    bg = bgmat, newpage = FALSE,
                    control = list(gap_ylab=3.5,
                                   symm = TRUE, epsilon = 0.01,
...
Logolas::nlogomaker(m, logoheight = "ic_log",
                    color_profile = color_profile,
                    frame_width = 1, pop_name = "",
                    newpage = FALSE,
                    control = list(quant = 0.5,
...
Logolas::nlogomaker(table,
                    ...
                    xlab = "Position",
                    pop_name = '',
                    control = list(quant = 0.5, epsilon=0.1,
                                   gap_ylab=3.5,
                                   round_off = 1,
                                   posbins = 2, negbins = 3))
